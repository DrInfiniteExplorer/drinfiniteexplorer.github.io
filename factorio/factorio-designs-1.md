...
![A large power pole, with green and red circuits connected](/assets/img/factorio-bus.png)
...
{::nomarkdown}<details><summary>This section contains the details for the negotiation protocol. Click to expand.</summary>{:/nomarkdown} 
...
![Addressable Memory](/assets/img/factorio-addressable-memory.png)
...
{::nomarkdown}<details><summary>Blueprint</summary>{:/} 
```blueprint
...
{::nomarkdown}<div class="img-host">{:/}

![Complete bus negotiator](/assets/img/factorio-bus-negotiator-complete.png)
...
![UUID generator](/assets/img/factorio-uuid.png)
